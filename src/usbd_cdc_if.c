...
/* USER CODE BEGIN PV */
/* Private variables ---------------------------------------------------------*/
extern int solenoidState0;
extern int solenoidState1;
extern int solenoidState2;
extern int solenoidState3;
extern int solenoidState4;
extern int solenoidState5;
extern int solenoidState6;
extern int solenoidState7;
extern int solenoidState8;
extern int igniterState0;
extern int igniterState1;
...
static int8_t CDC_Receive_FS(uint8_t* Buf, uint32_t* Len) {
    ...
    switch (Buf[0]) {
        ...
        case 0x39:
            ...
            break;
        case 0x47:
            igniterState0 = ~igniterState0;
            break;
        case 0x48:
            igniterState1 = ~igniterState1;
            break;
        case 0x41:
